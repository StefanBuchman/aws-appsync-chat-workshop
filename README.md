...
## AWS Amplify Console
The [AWS Amplify Console](https://aws.amazon.com/amplify/console/) service allows you to build a complete CI/CD pipeline directly from you GitBug repository.
